...
local library, pointers = loadstring(game:HttpGet("https://pastebin.com/raw/kwqE80C9"))()
do


    local window = library:New({name = "solx   - (rewrite) - "..version .." - " .."("..game.Players.LocalPlayer.UserId .. ")" , size = Vector2.new(555, 610), Accent = Color3.fromRGB(192, 118, 227)})
